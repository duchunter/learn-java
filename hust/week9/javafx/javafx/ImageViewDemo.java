...
public class ImageViewDemo extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		InputStream input = clazz.getResourceAsStream("/hust/soict/ictglobal/gui/javafx/image.png");

		Image image = new Image(input);

		ImageView imageView = new ImageView(image);

		InputStream input2 = clazz.getResourceAsStream("/hust/soict/ictglobal/gui/javafx/image.png");
